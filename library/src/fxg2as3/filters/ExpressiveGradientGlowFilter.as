package fxg2as3.filters
{
	...
	public class ExpressiveGradientGlowFilter extends GradientGlowFilter implements IExpressiveFilter
	{
		public function ExpressiveGradientGlowFilter(distance:Number=4.0, angle:Number=45, colors:Array=null, alphas:Array=null, ratios:Array=null, blurX:Number=4.0, blurY:Number=4.0, strength:Number=1, quality:int=1, type:String="outer", knockout:Boolean=false)
		{
		...
		public function cloneFilter():IExpressiveFilter
		{
			...
			return new ExpressiveGradientGlowFilter(distance, angle, localColors, localAlphas, localRatios, blurX, blurY, strength, quality, type, knockout);
		}
		...
		public function toAS3String(targetFlex3:Boolean, useVectorNotation:Boolean, numericPrintingPrecision:int):String
		{
			...
			return 'new GradientGlowFilter(' + distance + ', ' + angle + ', ' + FXGConverter.getExecutableArrayString(localColors, FXGConverter.convertColorUintToHexString) + ', ' + FXGConverter.getExecutableArrayString(localAlphas) + ', ' + FXGConverter.getExecutableArrayString(localRatios) + ', ' + blurX + ', ' + blurY + ', ' + strength + ', ' + quality + ', "' + type +'", ' + knockout + ')';
		}
	}
}